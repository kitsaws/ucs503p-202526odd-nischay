...
const EventDashboard = () => {
  ...
  return (
    <Layout>
      <section>
        <h2 className='text-4xl font-bold mb-2'>Discover Events</h2>
        <p className='text-muted-foreground mb-4'>Find hackathons, competitions, and workshops to join and grow your skills</p>
